...
@Component
public class DeviceReadonlyJpaRepository implements DeviceReadonlyRepository {
    ...
    public DeviceReadonlyJpaRepository(JdbcTemplate jdbcTemplate, JsonSerde jsonSerde) {
