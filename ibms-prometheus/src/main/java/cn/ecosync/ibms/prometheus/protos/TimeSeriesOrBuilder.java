...
public interface TimeSeriesOrBuilder extends
   ...
   */
  java.util.List<cn.ecosync.ibms.prometheus.protos.Sample> 
      getSamplesList();
  /**
   * <pre>
   * Timeseries messages can either specify samples or (native) histogram samples
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  cn.ecosync.ibms.prometheus.protos.Sample getSamples(int index);
  /**
   * <pre>
   * Timeseries messages can either specify samples or (native) histogram samples
   * (histogram field), but not both. For a typical sender (real-time metric
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  java.util.List<? extends cn.ecosync.ibms.prometheus.protos.SampleOrBuilder> 
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  cn.ecosync.ibms.prometheus.protos.SampleOrBuilder getSamplesOrBuilder(
      int index);

  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  java.util.List<cn.ecosync.ibms.prometheus.protos.Histogram> 
      getHistogramsList();
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  cn.ecosync.ibms.prometheus.protos.Histogram getHistograms(int index);
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
   ...
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  java.util.List<? extends cn.ecosync.ibms.prometheus.protos.HistogramOrBuilder> 
      getHistogramsOrBuilderList();
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  cn.ecosync.ibms.prometheus.protos.HistogramOrBuilder getHistogramsOrBuilder(
      int index);
   ...
   */
  java.util.List<cn.ecosync.ibms.prometheus.protos.Exemplar> 
      getExemplarsList();
  /**
   * <pre>
   * exemplars represents an optional set of exemplars attached to this series' samples.
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  cn.ecosync.ibms.prometheus.protos.Exemplar getExemplars(int index);
  /**
   * <pre>
   * exemplars represents an optional set of exemplars attached to this series' samples.
   * </pre>
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  java.util.List<? extends cn.ecosync.ibms.prometheus.protos.ExemplarOrBuilder> 
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  cn.ecosync.ibms.prometheus.protos.ExemplarOrBuilder getExemplarsOrBuilder(
      int index);
   ...
   * @return The metadata.
   */
  cn.ecosync.ibms.prometheus.protos.Metadata getMetadata();
  /**
   * <pre>
   * metadata represents the metadata associated with the given series' samples.
   * </pre>
   ...
   * <code>.io.prometheus.write.v2.Metadata metadata = 5;</code>
   */
  cn.ecosync.ibms.prometheus.protos.MetadataOrBuilder getMetadataOrBuilder();
