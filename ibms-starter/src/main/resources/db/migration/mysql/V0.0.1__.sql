CREATE TABLE device_data_acquisition
(
    ...
    CONSTRAINT pk_device_data_acquisition PRIMARY KEY (id),
    CONSTRAINT uk_device_data_acquisition UNIQUE (data_acquisition_code)
) COMMENT '设备数据采集';
...
(
    ...
    CONSTRAINT pk_device_data_point PRIMARY KEY (id),
    CONSTRAINT uk_device_data_point UNIQUE (device_code, metric_name)
) COMMENT '设备数据点位';
