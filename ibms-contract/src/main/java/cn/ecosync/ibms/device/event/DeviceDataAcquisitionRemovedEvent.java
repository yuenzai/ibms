...
public class DeviceDataAcquisitionRemovedEvent extends DeviceDataAcquisitionEvent {
    public static final String EVENT_TYPE = "device-daq-removed-event";
    ...
    public DeviceDataAcquisitionRemovedEvent(DeviceDataAcquisitionModel deviceDataAcquisitionModel) {
