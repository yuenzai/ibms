...
@ToString
public class DeviceSavedEvent extends AbstractDeviceEvent {
    public static final String EVENT_TYPE = "device-saved-event";
    ...
    protected DeviceSavedEvent() {
    }

    public DeviceSavedEvent(DeviceModel device) {
