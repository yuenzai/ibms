...
import cn.ecosync.aiot.edge.gateway.command.ImportBacnetDataPointsCommand;
...
import cn.ecosync.aiot.edge.gateway.model.DeviceDataAcquisitionType;
...
public class ImportBacnetDataPointsCommandHandler implements CommandHandler<ImportBacnetDataPointsCommand> {
    ...
    public ImportBacnetDataPointsCommandHandler(DeviceDataAcquisitionRepository dataAcquisitionRepository) {
