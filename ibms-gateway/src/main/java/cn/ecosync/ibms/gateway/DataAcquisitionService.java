...
public interface DataAcquisitionService {
    ...
    @HttpExchange(method = "POST", url = "/{data-acquisition-code}", headers = "Command-Type=SET_SYNCHRONIZATION_STATE")
    void execute(@PathVariable("data-acquisition-code") String dataAcquisitionCode, @RequestBody SetDataAcquisitionSynchronizationStateCommand command);
}
