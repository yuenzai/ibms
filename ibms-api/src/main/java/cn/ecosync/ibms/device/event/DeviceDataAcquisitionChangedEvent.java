...
@ToString
public class DeviceDataAcquisitionChangedEvent extends DeviceDataAcquisitionEvent {
    @JsonUnwrapped
    private DeviceDataAcquisition dataAcquisition;

    protected DeviceDataAcquisitionChangedEvent() {
    }

    public DeviceDataAcquisitionChangedEvent(DeviceDataAcquisition dataAcquisition) {
